...
document.getElementById("select").onclick = function(e) {
    ...
    passfield.placeholder = "Enter password for future referance";
...
document.getElementById("upload").onclick = function() {
    ...
    passfieldvalue=passfieldvalue.trim();
     if (passfieldvalue.includes(" ")){
        document.getElementById("show-info-status").innerHTML="password field not allowed white space";
        passfield.value="";
        passfield.focus();
    }
    else if (passfieldvalue==""){
        document.getElementById("show-info-status").innerHTML="password field not be empty";
        passfield.value="";
        passfield.focus();
    }
    else{
